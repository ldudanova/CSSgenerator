class Picker {
   ...
   this.eventListeners();
    ...
    build(){
        ...
        gradient.addColorStop(0.49, "rgb(0,0,255)");
    ...
    //    Circle picker
        ...
        eventListeners() {
            ...
            const onMouseDown = (e) => {
                ...
                let currentY = e.clientY - this.target.offsetTop - 60;
                    ...
                    && currentX < this.pickerCircle.x + this.pickerCircle.width)
                {
                    ...
                    console.log("this.target.offsetLeft: "+this.target.offsetLeft);
                    console.log("this.target.offsetTop: "+this.target.offsetTop);
                    console.log("e.clientX: "+e.clientX);
                    console.log("e.clientY: "+e.clientY);
                    console.log("onMouseDown elseX: "+currentX);
                    console.log("onMouseDown elseY: "+currentY);
                    console.log("this.pickerCircle.x: "+this.pickerCircle.x);
                    console.log("this.pickerCircle.y: "+this.pickerCircle.y);
                }
            }
...
setInterval(() => picker.draw(), 0.1); //to loop dragging

picker.onChange((color) => {
    let selected = document.getElementsByClassName('js-selected-color')[0];
    selected.style.background = `rgba(${color.r}, ${color.g}, ${color.b})`;
})